# Sphinx configuration for ads-mcp documentation
...
# Make sure the package is importable even in a clean docs build environment
...
project = "ads-mcp"
author = "ads-mcp contributors"
copyright = "2024, ads-mcp contributors"

try:
    release = importlib.metadata.version("ads-mcp")
...
# Source suffixes: accept .md and .rst
source_suffix = {
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/cgarling/ads-mcp/",
    "source_branch": "main",
    "source_directory": "docs/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/cgarling/ads-mcp",
            "html": """
